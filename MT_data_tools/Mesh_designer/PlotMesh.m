...
data_combine_x_list = cell2mat(data_combine_selected(:,2));
data_combine_y_list = cell2mat(data_combine_selected(:,3));
...
hold on;
scatter(data_combine_x_list,data_combine_y_list,'red','filled','^');
xlabel('X (m)');
ylabel('Y (m)');
title('XY Plane Grid');
...
hold on;
scatter(data_combine_x_list,0,'red','filled','^');
xlabel('X (m)');
ylabel('Z (m)');
title('XZ Plane Grid');
set(gca, 'FontName', 'Times New Roman', 'FontSize', 14, 'FontWeight', 'bold');
...
hold on;
scatter(data_combine_y_list,0,'red','filled','^');
xlabel('Y (m)');
ylabel('Z (m)');
title('YZ Plane Grid');
set(gca, 'FontName', 'Times New Roman', 'FontSize', 14, 'FontWeight', 'bold');
